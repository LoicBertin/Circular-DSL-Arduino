...
<model ref="r:d663c6e4-86a8-42ed-9545-0a025a1342b1(StateBasedAlarm.ArduinoML)">
  ...
  <node concept="2f$o0v" id="4C32DkkHL5o">
    <property role="TrG5h" value="StateBasedAlarm" />
    <ref role="2fAQMJ" node="4C32DkkHL5q" resolve="off" />
    <node concept="2f$o0o" id="4C32DkkHL8H" role="2f$o0u">
    ...
    <node concept="2fAQJg" id="4C32DkkHL5q" role="2fAQME">
      ...
      <node concept="2fAQRq" id="4C32DkkHL5r" role="2fAQPV">
        <property role="2fAQRs" value="523yQtkj5zp/true" />
        <ref role="2fAQRi" node="4C32DkkHLaU" resolve="button" />
        <ref role="2fAQRg" node="4C32DkkHLdw" resolve="on" />
      </node>
      <node concept="2O27BE" id="4C32DkkHLkV" role="2fAQP_">
        <property role="2O27Aq" value="523yQtkj5Bi/false" />
        <ref role="2fAQGV" node="4C32DkkHL8H" resolve="led" />
      </node>
    </node>
    <node concept="2fAQJg" id="4C32DkkHLdw" role="2fAQME">
      <property role="TrG5h" value="on" />
      <node concept="2fAQRq" id="4C32DkkHLdx" role="2fAQPV">
        <property role="2fAQRs" value="523yQtkj5zp/true" />
        <ref role="2fAQRi" node="4C32DkkHLaU" resolve="button" />
        <ref role="2fAQRg" node="4C32DkkHL5q" resolve="off" />
      </node>
      <node concept="2O27BE" id="4C32DkkHLn4" role="2fAQP_">
